...
### Added
- **Yard, pantry, and settings drop (HS-Q04 through HS-S04)** — Mod Options pack (allergy flare, favorite-food mood, coop interval, Kats on/off, cooling tooltip, larder/festival/aging/Living World flavor). Well-stocked larder mood from distinct preserves. Fall harvest festival at the maypole. Waxed cheese / smoked meat / cider age in the root cellar. Dairy shed, goose shelter, scarecrow, farmstand (local brand, not faction goodwill), waterwheel on moving water. Bees slow without bloom; maple sap runs in spring/cold; rain barrels follow weather and empty slowly in drought. Fox-on-coop and county-fair visitor incidents. Optional Living World famine/refugee flavor letters. Nemesis food raids prefer Homesteader pantry buildings. Dev actions: force festival / fox / fair, brand, larder cache. CN/RU keyed + yard DefInjected. Goat pen stays gone.
...
- **Update idea pool** — Workshop QoL plus pantry/yard/farmstand/waterwheel phases. **Pool implemented** (Q04–S04). Goat pen stays removed. Animal poop is a separate draft PR. Spec: [docs/ideas/homesteader-updates.md](../docs/ideas/homesteader-updates.md) · [next-content.md](../docs/ideas/next-content.md).
