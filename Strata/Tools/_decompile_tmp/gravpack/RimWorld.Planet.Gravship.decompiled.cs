...
public class Gravship : WorldObject, IIncidentTarget, ILoadReferenceable
{
	...
	private void AddThing(Thing thing, IntVec3 offset)
	{
		...
		{
			ThingWithComps thingWithComps = comp2.connectParent?.parent;
			if (thingWithComps != null && engine.OnValidSubstructure(thingWithComps))
			{
				connectParents.Add(thing, thingWithComps);
			}
		}
