...
- **Docs** — Strata V3 target locked (`feature/strata-v3`, includes VGE Chapter 1 compat): G1–G7 / A1–A5 / M1–M8 (no M5), ±4 cap. → [docs/strata-roadmap.html](docs/strata-roadmap.html)
