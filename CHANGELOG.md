...
- **Homesteader** — animals drop animal poop for the compost heap (required ingredient); piles expire so they do not clog maps. → [Homesteader/CHANGELOG.md](Homesteader/CHANGELOG.md)
