...

{
...

    {
...

        {
            ...
            EnsureLandingPad(under, landingSpot);
        ...
        private static void EnsureLandingPad(Map under, IntVec3 spot)

        {
            ...
            foreach (IntVec3 cell in GenRadial.RadialCellsAround(spot, UpperDeckUtility.DefaultPlazaRadius, useCenter: true))

            {

                if (!cell.InBounds(under))
                ...
                under.terrainGrid.SetTerrain(cell, deck);

                under.roofGrid.SetRoof(cell, RoofDefOf.RoofConstructed);
