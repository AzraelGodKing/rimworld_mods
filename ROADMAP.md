...
**Idea sweep (Sep 2026):** [idea-sweep-2026-09.md](docs/ideas/idea-sweep-2026-09.md) — 10 features + 10 simple fixes per mod. Triaged new systems: **Strata 4.0** absorbs on-map logistics (Teamster), **Deep Colony 2.0.0** absorbs physical health (Ward) with a fail-open bridge to all eight siblings, **Living World** absorbs expeditions and the goods economy (Trailblazer / Tradecraft). Six standalone candidates remain — Menagerie, Charter, Codex, Bulwark, Wildland, Revel.
