...
- **Deep Colony touch traits** (`touch-need-v1`) — **1.6.0**. Named comfort tiers; touch-averse degrees (reserved / averse / intolerant); new **touch-starved**, **tactile**, and **cuddly**. Romance waits until the required tier. Date Night still owns romance schedules. → [Deep Colony/CHANGELOG.md](Deep%20Colony/CHANGELOG.md)
- **Date Night schedule tab** (`schedule-imgui-v1`) — opening Schedule no longer warns; Date still sits last on the extra row. Date Night stays **1.0.1**. → [DateNight/CHANGELOG.md](DateNight/CHANGELOG.md)
...
- **Strata cavern floors** (`cavern-biome-depth-v1`) — **3.1.0**. With [Biomes! Caverns](https://steamcommunity.com/sharedfiles/filedetails/?id=2969748433), B1–B2 are no longer locked to Earthen Depths (wet → fungal, cold → crystal, magma earthen deeper). → [Strata/CHANGELOG.md](Strata/CHANGELOG.md)
