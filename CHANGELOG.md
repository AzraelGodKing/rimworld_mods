...
- **Strata** — multi-hop relay chaining (food/work/medical/joy/robots + rest); drafted/bunker stair detours; cross-level haul to blueprints; bedrooms (#31); Geological Landforms compat; Russian translation; gas defaults/perf. → [Strata/CHANGELOG.md](Strata/CHANGELOG.md)
