...
- **Strata** — cross-level haul: auto-refuel + higher-priority storage pulls; Anomaly Capture Harmony startup fix (`__result` first). → [Strata/CHANGELOG.md](Strata/CHANGELOG.md)
