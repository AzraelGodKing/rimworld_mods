...
### Changed
- **Workshop preview** (`preview-redraw-v2`) — `About/Preview.png` is a flat Power-tab card of Stormproof building sprites (nearest-neighbor, no painted scene). Docs hub card synced. Under Steam's 1 MB cap.
