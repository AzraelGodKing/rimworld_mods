...
- **Strata** — cross-level stockpile haul deliver (no wander-with-cargo); sleep/work multi-hop relays; sealed-stair detours; bedrooms (#31); Geological Landforms compat; Russian translation; gas defaults/perf. → [Strata/CHANGELOG.md](Strata/CHANGELOG.md)
