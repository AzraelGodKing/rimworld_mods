...
- **Update idea pool** — Workshop QoL (architect tab, ASF Storage patch, texture audit, settings) plus pantry/yard/farmstand/waterwheel phases. Goat pen stays removed; dairy shed is the livestock follow-up. Series Slice 1 starts at **HS-Q04**. Animal poop compost is a separate draft PR. Spec: [docs/ideas/homesteader-updates.md](../docs/ideas/homesteader-updates.md) · [next-content.md](../docs/ideas/next-content.md).
