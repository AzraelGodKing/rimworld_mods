...
- **Homesteader** — water buildings form an upgrade ladder (barrel → cistern → tower; hand-dug → deep well; still is boiled-water sidegrade). → [Homesteader/CHANGELOG.md](Homesteader/CHANGELOG.md)
