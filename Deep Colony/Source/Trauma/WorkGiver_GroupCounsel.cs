...
{
    public class WorkGiver_GroupCounsel : WorkGiver_Scanner
    {
        ...
        public override bool HasJobOnThing(Pawn pawn, Thing t, bool forced = false)
        {
            ...
            if (TraumaUtility.CountTraumatizedInRoom(patient) < 2) return false;
        ...
        {
            return JobMaker.MakeJob(DC_DefOf.DC_Job_GroupCounsel, t);
        }
    }
}
