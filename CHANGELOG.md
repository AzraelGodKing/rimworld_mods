...
- **Date Night schedule tab** (`schedule-imgui-v1`) — opening Schedule no longer warns; Date still sits last on the extra row. → [DateNight/CHANGELOG.md](DateNight/CHANGELOG.md)
