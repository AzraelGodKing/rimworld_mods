...
- **Level hotkeys**: Page Up / Page Down flip the camera one level up or down, keeping the same relative position over the base — no more scrolling to a staircase to peek downstairs. Rebindable under Options > Keyboard (camera section).
